...
> = {
  "ig-poster": {
    title: "IG Poster",
    description:
      "Scroll-stopping Instagram posters designed to convert feed traffic into followers.",
    ...
    items: [
      ...
      {
        img: "https://images.unsplash.com/photo-1633409361618-c73427e4e206?w=800&q=80",
        price: "$22",
      },
      {
  ...
  representation: {
    ...
    items: [
      ...
      {
        img: "https://images.unsplash.com/photo-1460794418188-1bb7dba2720d?w=800&q=80",
        price: "$70",
      },
    ],
  },
  flyer: {
    ...
    items: [
      ...
      {
        img: "https://images.unsplash.com/photo-1496337589254-7e19d01cec44?w=800&q=80",
        price: "$22",
      },
    ],
  },
  invitation: {
    ...
    items: [
      ...
      {
        img: "https://images.unsplash.com/photo-1530023367847-a683933f4172?w=800&q=80",
        price: "$20",
      },
      {
        img: "https://images.unsplash.com/photo-1478146896981-b80fe463b330?w=800&q=80",
        price: "$28",
      },
      {
  ...
  brochure: {
    ...
    items: [
      ...
      {
        img: "https://images.unsplash.com/photo-1531346680769-a1d79b57de5c?w=800&q=80",
        price: "$32",
      },
    ],
  },
  "business-card": {
    ...
    items: [
      {
        img: "https://images.unsplash.com/photo-1606857521015-7f9fcf423740?w=800&q=80",
        price: "$10",
      },
      {
        img: "https://images.unsplash.com/photo-1572502007796-7891beba293e?w=800&q=80",
        price: "$12",
      },
      {
        img: "https://images.unsplash.com/photo-1622151834625-8b9ae5d7e15c?w=800&q=80",
        price: "$15",
      },
      {
        img: "https://images.unsplash.com/photo-1626197031507-c17099753214?w=800&q=80",
        price: "$11",
      },
      {
      ...
      {
        img: "https://images.unsplash.com/photo-1589330694653-ded6df03f754?w=800&q=80",
        price: "$13",
      },
    ],
  },
  "album-cover": {
    ...
    items: [
      ...
      {
        img: "https://images.unsplash.com/photo-1507901747481-84a4f64fda6d?w=800&q=80",
        price: "$38",
      },
      {
  ...
  logo: {
    ...
    items: [
      ...
      {
        img: "https://images.unsplash.com/photo-1599305445671-ac291c95aaa9?w=800&q=80",
        price: "$90",
      },
      {
        img: "https://images.unsplash.com/photo-1620287341056-49a2f1ab2fdc?w=800&q=80",
        price: "$65",
      },
      {
        img: "https://images.unsplash.com/photo-1614036417651-efe5912149d8?w=800&q=80",
        price: "$80",
      },
      {
        ...
        <div className="w-full">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {data.items.map((item, i) => (
              <article key={i} className="rounded-[3px] border-[1.5px] border-ink/15 bg-paper p-4">
